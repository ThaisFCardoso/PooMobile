...
class Empregado extends Pessoa {
  ...
  Empregado.completo(String nome, String endereco, String telefone, 
  ...
  @override
  String toString() {
    return 'Empregado{nome: $nome, endereco: $endereco, telefone: $telefone, '
           'codigoSetor: $_codigoSetor, salarioBase: $_salarioBase, '
           'imposto: $_imposto%, salarioLiquido: ${calcularSalario()}}';
  }
}